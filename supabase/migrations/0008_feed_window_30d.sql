-- 30-day shelf: score ordering keeps fresh on top; sparse topics keep their archive visible.
-- 30 days + read-time decay keeps ordering sane while giving every source a shelf.
